...
1. **Read the PR description template:**
   - First, check if there is a Pull request template on git folder `.github`, if dont, sugest a description. Always in Brazillian Portuguese, except when user explicitly tells different
